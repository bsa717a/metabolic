  ...
  return (
    <div
      className={clsx(
        ...
        pinWhileScrolling
          ? 'sticky bottom-4 z-10 flex max-h-[calc(100dvh-8rem)] flex-col self-start sm:max-h-[calc(100vh-2rem)] lg:bottom-auto lg:top-[var(--app-sticky-offset)] lg:max-h-[calc(100vh-var(--app-sticky-offset)-1rem)] shadow-lg lg:shadow-sm'
          : 'shadow-sm'
      )}
    >
